	...
	<div class="production-news">
		<div class="production">
			...
			<div class="svg-menu">
				<div class="svg-str">
					<div class="svg-item">
						<a href="template/production.html">
		...
		<div class="news">
			...
			<article>
				<h3>Нова колекція</h3>
				<p>Нова колекція тканини для вертикальних жалюзей 127мм, 89мм</p>
		...
		<div class="wrapper-gallery">
			<div class="gallery-on">
				...
				<div class="button-center">
					<a href="/template/portfolio.html"><button class="more-photo-button">Ще фото &#8194;
