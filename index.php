...
<body>
	...
	<div class="repair">
		...
		<div class="repair-text">
			<h2>Ремонт жалюзі всіх видів, заміна деталей</h2>
			<p class="repair-description">Наші спеціалісти професійно та оперативно підберуть всі необхідні деталі і виконають ремонт жалюзі
				будь-якої складності. Дадуть цінні поради щодо правильної експлуатації та догляду за ними.</p>
			<p class="repair-phone-us">Потрібен ремонт жалюзі? Телефонуйте нам і ми Вам допоможемо!</p>
